    ...
    const recipes = [
      {
        ...
        description:
          'The classic Daiquiri is a super simple rum cocktail that’s well-balanced and refreshing. The combination of sweet, \
            sour and spirit is refreshingly tangy and perfect for any occasion.',
        ingredients: [
          {
      ...
      },
      {
        ...
        description:
          'The Piña Colada is a classic tropical cocktail with rum, pineapple and coconut milk. This classic recipe will \
            transport you to paradise. Getting caught in the rain is not required.',
        ingredients: [
          {
      ...
      },
      {
        ...
        description:
          'To many people, the Mojito represents the perfect rum cocktail. The origins of the drink can be traced \
            back to Cuba and the 16th-century Cuban cocktail El Draque, named for Sir Francis Drake. ',
        ingredients: [
          {
            name: 'Mint leaves',
            quantity: 6
